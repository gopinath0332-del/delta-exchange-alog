...
DATA_DIR = r"D:\Workspace\crypto-backtest-data\delta_crypto_data_4H"
...
def main():
    ...
    print(f"Found {len(files)} 4H files to process.")
    ...
    for candle in candle_styles:
        for pct in stop_loss_pcts:
            ...
            out_file = f"scratch/batch_backtests/results_4h_{scenario_name}.csv"
            
            print(f"\n--- Running SCENARIO: 4H {scenario_name} ---")
